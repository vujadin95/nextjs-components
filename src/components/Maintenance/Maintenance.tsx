...
const Maintenance = () => {
  ...
  return (
    <div className="flex h-[calc(100vh_-_140px)] w-full max-w-full flex-col items-center justify-between">
      <div className="flex flex-1 flex-col items-center justify-center px-4 text-center lg:px-0 xl:w-1/2">
        ...
        <p className="mt-8 w-full max-w-[550px] text-4xl font-bold capitalize tracking-wide text-gray-700">
          {t("heading")}
        </p>
      ...
      <div className="w-full border-t border-gray-300 py-4">
        <div className="container mx-auto flex flex-col items-center justify-center space-y-1 text-sm text-gray-600 md:flex-row md:space-x-8 md:space-y-0">
          <span className="font-bold">{t("contactuslabel")}</span>
          <a
            target="_blank"
